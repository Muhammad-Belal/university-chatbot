...
if not st.session_state.logged_in:
    ...
    st.markdown("<p style='text-align:center;color:#8a8a8a;font-size:14px;margin-bottom:24px;'>Islamia University Bahawalpur &amp; BZU Multan</p>", unsafe_allow_html=True)
